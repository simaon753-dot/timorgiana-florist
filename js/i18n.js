...
App.T = {
  ...
  /* —— ENCOMENDA PERSONALIZADA (configurador) —— */
  nav_personalizar:{ pt:"Encomenda Personalizada", tet:"Enkomenda Personalizadu", en:"Custom Order" },
  persp_titulo:  { pt:"Encomenda Personalizada", tet:"Enkomenda Personalizadu", en:"Custom Order" },
  persp_sub:     { pt:"Crie o seu bouquet ou arranjo à medida — escolha, descreva e nós fazemos.", tet:"Kria ita-nia ramu ka aranju rasik — hili, deskreve, ami halo.", en:"Design your own bouquet or arrangement — pick, describe, and we'll make it." },
  pers_tipo:     { pt:"Tipo de arranjo", tet:"Tipu aranju", en:"Arrangement type" },
  pers_flores:   { pt:"Flores preferidas", tet:"Ai-funan preferidu", en:"Preferred flowers" },
  pers_cores:    { pt:"Cores", tet:"Kór", en:"Colours" },
  pers_tamanho:  { pt:"Tamanho", tet:"Tamañu", en:"Size" },
  pers_embrulho: { pt:"Papel de embrulho", tet:"Papel embrulhu", en:"Wrapping paper" },
  pers_fita:     { pt:"Fita / laço", tet:"Fita / laçu", en:"Ribbon / bow" },
  pers_extras:   { pt:"Extras", tet:"Extra sira", en:"Extras" },
  pers_ocasiao:  { pt:"Ocasião", tet:"Okaziaun", en:"Occasion" },
  pers_orcamento:{ pt:"Orçamento aproximado (opcional)", tet:"Orsamentu aproximadu (opsionál)", en:"Approx. budget (optional)" },
  pers_orcamento_ph:{ pt:"Ex.: $30", tet:"Ez.: $30", en:"e.g. $30" },
  pers_descricao:{ pt:"Descreva o que pretende", tet:"Deskreve saida ita hakarak", en:"Describe what you'd like" },
  pers_descricao_ph:{ pt:"Ex.: um ramo romântico com rosas cor-de-rosa e verdes, embrulho creme…", tet:"Ez.: ramu romántiku ho roza rosa…", en:"e.g. a romantic bouquet with pink roses and greenery, cream wrap…" },
  pers_cartao:   { pt:"Mensagem do cartão (opcional)", tet:"Mensajen kartaun (opsionál)", en:"Card message (optional)" },
  pers_cartao_ph:{ pt:"Ex.: Feliz aniversário, com amor.", tet:"Ez.: Parabéns, ho domin.", en:"e.g. Happy birthday, with love." },
  pers_fotos:    { pt:"Fotografias de referência", tet:"Foto referénsia", en:"Reference photos" },
  pers_fotos_nota:{ pt:"Escolha as fotos de exemplo e anexe-as na conversa do WhatsApp (📎) ao enviar.", tet:"Hili foto no tau iha WhatsApp (📎) bainhira haruka.", en:"Pick example photos and attach them in the WhatsApp chat (📎) when you send." },
  pers_multi:    { pt:"(pode escolher várias)", tet:"(bele hili barak)", en:"(choose several)" },
  pers_resumo:   { pt:"Resumo do seu pedido", tet:"Rezumu ita-nia pedidu", en:"Your request" },
  pers_vazio:    { pt:"Vá escolhendo — o resumo aparece aqui.", tet:"Hili — rezumu sei mosu iha ne'e.", en:"Start choosing — your summary appears here." },
  pers_enviar:   { pt:"Pedir orçamento por WhatsApp", tet:"Husu orsamentu liu WhatsApp", en:"Request a quote on WhatsApp" },
  pers_preco_nota:{ pt:"Sob consulta — confirmamos o preço no WhatsApp.", tet:"Tuir konsulta — konfirma presu iha WhatsApp.", en:"On request — we confirm the price on WhatsApp." },
  pers_nfotos:   { pt:"foto(s) escolhida(s)", tet:"foto hili tiha", en:"photo(s) selected" },
